...
function ErrorTile({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Tile, { className: "text-center py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold mb-2", children: "Couldn't load courses" }),
...
const SplitErrorComponent = ({
  error,
  reset
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorTile, { error, reset });
export {
