...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CSk9oAWw.mjs");
...
const manifest = {
  "7ed414b627119343abbb5f5a3f21ecec84d79c7c95b26590d8b2cb51c452790e": {
    functionName: "updateProgress_createServerFn_handler",
    importer: () => import("./dashboard.functions-9z-1sgtl.mjs")
  },
  "b59dc20ac2c1e5e958d5a8a40005a9e8ebd2ca895fd31610b71188ee0b98a0e3": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D3vW-uS8.mjs").then((n) => n.r),
    import("./start-CRVJdq1d.mjs"),
